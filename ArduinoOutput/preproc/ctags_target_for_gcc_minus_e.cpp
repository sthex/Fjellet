# 1 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino"
//#include <hexpwd.h>
# 3 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
# 4 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
# 5 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
# 6 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
# 7 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
# 8 "d:\\ReposD\\Fjellet\\VannTemp\\VannTemp.ino" 2
...
__attribute__((section(".rtc.data" "." "20"))) int kabelMode = 2; //0:off, 1:auto, 3:on
__attribute__((section(".rtc.data" "." "21"))) int vvbTempSet = 10; // Auto temperature
__attribute__((section(".rtc.data" "." "22"))) int kabelTempSet = 8; // Auto temperature about 50% on
__attribute__((section(".rtc.data" "." "23"))) int bootCount = 0;
__attribute__((section(".rtc.data" "." "24"))) int lastCh1 = 9; //Aux 0=off  1=on 9=ukjent fra start
__attribute__((section(".rtc.data" "." "25"))) int lastCh2 = 9; //Kabel
__attribute__((section(".rtc.data" "." "26"))) int lastCh3 = 9; //VVB
__attribute__((section(".rtc.data" "." "27"))) bool pulseAlways = false; //Send ouput on every check in auto
__attribute__((section(".rtc.data" "." "28"))) int ignoreSensorBit = 0x01; // ignore sensor 1 (i jorden under inntak) siden den er veldig treg/dempet
...
void GotoSleep()
{
 if (sleepMinutes > 0)
 {
  ...
  esp_sleep_enable_timer_wakeup(sleepMinutes * 60000000 /* Conversion factor for micro seconds to minutes */);
